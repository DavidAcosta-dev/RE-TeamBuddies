...
CTRL_RE = re.compile(r'pad|controller|dualshock|rumble|button|input|deadzone|libpad', re.IGNORECASE)
PHYS_RE = re.compile(r'gravity|jump|vel|accel|decel|friction|speed|air|strafe|throw|kick|move|rcnt|vsync|timer', re.IGNORECASE)
